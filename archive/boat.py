...
class Boat:
    def __init__(self, boat_config):
        self.max_boat_turn_rate_dps = float(boat_config.get_max_boat_turn_rate_dps()) # Angular velocity of boat with rudder hard over. TODO: Consider speed, point of sail
        self.rudder_speed_dps = float(boat_config.get_max_rudder_speed_dps()) # Speed at which actuator moves rudder rudder. Determine empirically.
